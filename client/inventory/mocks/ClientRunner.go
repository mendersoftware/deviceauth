...
func (_m *ClientRunner) AddDevice(ctx context.Context, req inventory.AddReq, client apiclient.HttpRunner) error {
	ret := _m.Called(ctx, req, client)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, inventory.AddReq, apiclient.HttpRunner) error); ok {
