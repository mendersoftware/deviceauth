...
type Device struct {
	...
	IntervalDeploymentsNext time.Duration          `json:"interval_deployments_next,omitempty" bson:"interval_deployments_next,omitempty"`
	IntervalInventoryUpdate time.Duration          `json:"interval_inventory_update,omitempty" bson:"interval_inventory_update,omitempty"`
}
